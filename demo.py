...
#    the screenmanager and how they should be referenced
...
#    the navigation side-panel. Each item in the list is used to configure
#    either a:
#
...
#       Construction of a ScreenNavigationEntry instance
...
app_config_entries = ['Demo Screens',
                      ...
                      ScreenNavigationEntry(CustomCheckBoxDemoScreen, 'Custom CheckBoxes',
                                            button_icon='fa-check-square'),
...
#
# Include themes or font types to override default application
